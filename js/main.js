...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if (value > 80) $(".navbar-inverse").css("background", "#fff");
    else $(".navbar-inverse").css("background", "transparent");
  });
  ...
  $(window).scroll(function () {
    ...
    else $(".navbar-lg .navbar-nav > li > a").css("color", "rgba(0,0,0,.9)");
  });
  ...
  $(window).scroll(function () {
    ...
    if (value > 80)
      $(".navbar-inverse").css(
        "box-shadow",
        " 11px 15px 29px 0 rgba(48,48,48,0.07)"
      );
    else $(".navbar-inverse").css("box-shadow", "none");
  });
